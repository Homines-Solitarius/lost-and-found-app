...
const LoginForm = () => {
  ...
  return (
    <div className="p-5 m-auto">
        <h3 className='text-xl font-bold text-center m-4 lg:text-3xl lg:my-10'>Welcome back you&apos;ve been missed.</h3>
        ...
        <div className='flex items-center gap-1'>
          ...
          <Link href='/register' className='text-blue-700'>Register now</Link>
        </div>
      </form>
   </div>
  )
